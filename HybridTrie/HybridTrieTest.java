...
import java.io.*;
import java.util.*;
import TriePackage.*;  // Trie files are all in this package
...
public class HybridTrieTest
{
	public static void main(String [] args) throws IOException
	{
		...
		// to the file name provided in args[1].  If we were actually using this trie
		// in a productive way, the name in args[0] should match that in args[1] (i.e.
		// we would have only one file containing the words).  However, for testing
		// purposes we are using 2 names so that the original and saved files can be
		// compared.
		D.save(args[1]);
	}
}
